...
.nav-links {
    ...
    max-width: 100%;
      ...
      .main{
    width: 100%;
    background-image: url('images/SkinPage/SkinSlidePage1.jpg');
...
@keyframes changeBackground {
    0% {
        background-image: url('images/SkinPage/SkinSlidePage2.jpg');
    }
    30% {
        background-image: url('images/SkinPage/SkinSlidePage3.jpg');
    }
}
.main-content{
    width: 1200px;
    ...
    ?>
       ...
       <div class="main">
         <div class="main-content">
              <h3>Skin</h3>
              <div>Plump, Brighten and Glaze : Shop moisturizers,serums,sunscreens and more.</div>
...
<div class="card-heading">
    ...
    <!--Card1-->
    <div class="card">
        <img src="images/SkinPage/Moist1.png">--
        <div class="card-content">
            <b>Plum Bright skin Essential kit with Rice Water serum</b>
            <p>Rs.1,101</p>
