...
<head>
    ...
    <style>
        .main{
    width: 100%;
    background-image: url('image/Fragrance/backimg1.jpg');
...
@keyframes changeBackground {
    0% {
        background-image: url('image/Fragrance/backimg2.jpg');
    }
    30% {
        background-image: url('image/Fragrance/backimg3.jpg');
    }
}
.main-content{
    width: 1200px;
    ...
    ?>
       ...
       <div class="main">
         <div class="main-content">
              <h3>Fragrances</h3>
              <div>Refresh, Spritz, Mist: Shop Perfumes, Deodrants, Roll-ons and more</div>
...
<div class="card-heading">
    ...
    <!--Card1-->
    <div class="card">
        <img src="image/Fragrance/frag16.png">
