...
<head>
    ...
    <style>
        .main{
    width: 100%;
    background-image: url('image/HairPage/Backimg1.jpg');
...
@keyframes changeBackground {
    0% {
        background-image: url('image/HairPage/Backimg2.jpg');
    }
    30% {
        background-image: url('image/HairPage/Backimg3.jpg');
    }
}
.main-content{
    width: 1200px;
    ...
    ?>
       ...
       <div class="main">
         <div class="main-content">
              <h3>Hairs</h3>
              <div>Restore, Repair, Style: Shop shampoos, conditioners, accessories and more</div>
...
<div class="card-heading">
      ...
      <div class="card-container">
        <!--Card1-->
        <div class="card">
            <img src="image/HairPage/shampoo1.png">
